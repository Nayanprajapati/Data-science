library(tidyverse)
library(dplyr)
broad_data1 = read_csv("C:/Users/33751/Desktop/data science/download file/201809_fixed_pc_r03/201805_fixed_pc_performance_r03.csv")
broad_data2 = read_csv("C:/Users/33751/Desktop/data science/download file/201809_fixed_pc_r03/201809_fixed_pc_coverage_r01.csv")
View(broad_data1)
View(broad_data2)

# Assuming 'common_column' is the common column for merging
...
write_csv(merged_data, "C:/Users/33751/Desktop/data science/Clean_Broadband.csv")
